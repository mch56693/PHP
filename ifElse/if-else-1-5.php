...
print "    <img src=\"img/$dado5.svg\" alt=\"$dado5\" width=\"140\" height=\"140\">\n";
print "    <img src=\"img/$dado6.svg\" alt=\"$dado6\" width=\"140\" height=\"140\">\n";
print "  </td>\n";
print "  \n";

if ($dado1 + $dado2 + $dado3 > $dado4 + $dado5 + $dado6) {
    print "  <p>Ha ganado el jugador 1</p>\n";
} else if ($dado1 + $dado2 + $dado3 < $dado4 + $dado5 + $dado6) {
